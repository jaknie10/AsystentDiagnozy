          ...
          child: Padding(
            ...
            child: Column(
              ...
              Padding(
                ...
                child: Text("Cześć, ${imie} ${nazwisko}", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
              ),
              Row(
                children: [
                Expanded(
                            ...
                            Row(
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text("Liczba pacjentów:", style: TextStyle( fontSize: 15),),
                                ...
                                Column(
                                  ...
                                  Padding(
                                            padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                            child: Text("Morfologia", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                          ),
                                  Padding(
                                            padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                            child: Text("100", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                          ),
                                ],),
                              ],
                            )    
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                        Padding(
                                          padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                          child: Text("Jan Kowalski", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                        ),
                                        Padding(
                                          padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                          child: Text("10-10-2010", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                        ),
                                        Padding(
                                          padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                          child: Text("jankowalski@gmail.com", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                        ),
                                      ],),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                        Padding(
                                          padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                          child: Text("1234567", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                        ),
                                        Padding(
                                          padding: EdgeInsets.only(bottom: 40.0, left: 10.0, right: 10.0, top: 10.0),
                                          child: Text("00123456789", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),),
                                        ),
                                  ],),
                          ...
                          child: TextButton(
                              onPressed: () async {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ProfileEdit(doctorId: 1),
                                  ),
                                );
                              },
